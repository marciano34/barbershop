                            ...
                            <table>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        echo '<form action="php/editarBarbeiroC.php" method="POST">';
                                        while ($row = $result->fetch_object()) {
                                            ...
                                            <th><button class="submit" name="id" value="'.$row->id.'" type="submit">Atualizar</button></th>
