                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        while ($row = $result->fetch_object()) {
                                            ...
                                            <th><form action="php/excluirBarbeiroC.php" method="POST"><button class="submit" name="id" value="'.$row->id_barbeiro.'" type="submit">Excluir</button></form></th>
                                            <th><form action="php/editarBarbeiroC.php" method="POST"><button class="submit" name="id" value="'.$row->id_barbeiro.'" type="submit">Editar</button></form></th>
                                          </tr>
                                        ';
                                        }
                                        ?>
                        ...
                        <div class="table-responsive">
                            <table>
                                ...
                                <tr>
                                            ...
                                            <th>' . $row->aniversario . '</th>
                                            <th>' . $row->datainicio . '</th>
                                            <th><form action="php/excluirAdmC.php" method="POST"><button class="submit" name="id" value="'.$row->id_empresa.'" type="submit">Excluir</button></form></th>
                                            <th><form action="php/editarAdmC.php" method="POST"><button class="submit" name="id" value="'.$row->id_empresa.'" type="submit">Editar</button></form></th>
                                  </tr>
                            ';
                                        }
                                        ?>
